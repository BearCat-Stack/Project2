...
A local CLI tool that generates personalized cold outreach emails for finance networking.

## What it does

1. Accepts a prospect via LinkedIn URL **or** Name + Company.
2. 2. Uses Apollo (and optionally a LinkedIn proxy API) to gather verified contact and career data.
   3. 3. Produces fact-grounded background intelligence.
      4. 4. Generates a high-conversion, personalized cold email in elite finance networking style.
         5. 5. Applies quality control scoring and only accepts drafts rated **8/10+**.
            6. 6. Opens Gmail and composes (but does **not** send) the draft for human review.
                                    ...
                                    - - 3 Subject Lines
                                      - - Final Email (90-130 words)
                                        - - QC score and rationale
                                          ...
                                          - - The prompt enforces strict evidence grounding — no hallucination.
                                            - - Personalization is conservative when evidence is sparse.
                                              - - Any draft under 8/10 QC triggers rejection and retry.
                                                - - Gmail automation opens Compose, fills recipient/subject/body, then pauses for your review. It never clicks Send.
